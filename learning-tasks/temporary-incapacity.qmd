---
title: "Expert Evaluation of Temporary Incapacity for Work"
...
**Focus:** Long-term sick leave, continuous incapacity limits, and the role of TELK.
...
::: {.callout-note title="Answer for Checking" collapse="true"}
1. After 180 days of continuous temporary incapacity, the MCC is legally obligated to stop issuing sick leave and **must refer the patient to a Territorial Expert Medical Commission (TELK)**.
2. For severe conditions like traumatic injuries where recovery is clearly expected, TELK can authorize the extension of the temporary incapacity for **up to 2 months at a time**. However, the absolute maximum duration allowed for continuous temporary incapacity is **18 months**.
:::

---

### Scenario 3: Calculating Permanent Functional Limitation (TELK)

**Focus:** Multiple impairments, calculation methodology, and disability grouping.

**Background Data:** A 58-year-old patient is evaluated by TELK for a permanent reduction in working capacity. The commission identifies two distinct impairments based on the medical documentation: 
