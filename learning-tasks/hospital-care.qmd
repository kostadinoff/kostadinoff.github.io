...
subtitle: "Practical Class 7 · Academic Year 2025/2026"
...
> **Instructions.** Each group receives one scenario. Work through the tasks in sequence — each calculation feeds into the next. Show all working. For discussion questions, prepare a brief answer (3–5 sentences) that the group will present to the class. The synthesis task at the end is completed jointly across all groups.
