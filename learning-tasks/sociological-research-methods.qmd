...
**Learning Objectives:**
1. Match research methods to research questions and purposes.
2. Design concrete data collection instruments based on "hints."
3. Defend methodological trade-offs (e.g., Depth vs. Breadth, Ethics vs. Realism).

**Facilitation:**
- Give groups 25 minutes to build their instrument using the hints.
- The "Battle": Group A presents for 3 minutes, Group B critiques for 2 minutes, then vice-versa.