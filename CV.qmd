...
- Academic Mentor | Project BG05SFPR001-3.002-0001 "From Higher Education to Employment" ("ОТ ВИСШЕ ОБРАЗОВАНИЕ КЪМ ЗАЕТОСТ") | Goal: Achieving a dynamic match between higher education supply and labor market demand by improving practical skills, promoting dual education, and strengthening university-employer partnerships
...
- Работна среща на МЗ, МЗХ, БАБХ, РЗИ и „Информационно обслужване“ АД | *„Подобряване на надзора на грип и други вирусни респираторни патогени чрез интегриране на всички съществуващи системи за надзор и използване на единен подход в сферата на здравеопазването на хората и здравеопазването на животните. Работа по регионални и специфични за страната въпроси: свързани с грипа в Югоизточна Европа“* | Лектор
