...
subtitle: "MD, PhD, MPH, MSc · Chief Assistant Professor, Medical University of Plovdiv"
...
::: {.cv-contact}
{{< fa envelope >}} [drkostadinkostadinov@gmail.com](mailto:drkostadinkostadinov@gmail.com) &nbsp;·&nbsp; {{< fa brands github >}} [GitHub](https://github.com/kostadinoff) &nbsp;·&nbsp; {{< fa brands twitter >}} [Twitter](https://twitter.com/kostadinoffMD) &nbsp;·&nbsp; {{< fa brands linkedin >}} [LinkedIn](https://linkedin.com/in/kostadinovmd) &nbsp;·&nbsp; {{< fa brands orcid >}} [ORCID](https://orcid.org/0000-0003-1414-8738)
:::
:::

::: {.content-visible when-format="pdf"}
drkostadinkostadinov@gmail.com  |  [GitHub](https://github.com/kostadinoff)  |  [Twitter](https://twitter.com/kostadinoffMD)  |  [LinkedIn](https://linkedin.com/in/kostadinovmd)  |  [ORCID](https://orcid.org/0000-0003-1414-8738)
:::
...
- Master’s in Law | Burgas Free University
...
- OpenAQ Community Ambassador | OpenAQ | Advocating for air quality data transparency, open data utilization, and air pollution monitoring in local communities
...
Engaging in academic and instructional endeavors within a diverse setting encompassing students from medical, dental, pharmacy, and nursing disciplines. Contributing to postgraduate programs with attendees hailing from various continents. Actively involved in social and charitable initiatives of non-profit and non-governmental entities. Professional development in Ireland, Greece, Austria, Estonia, Germany, Finland and the United Kingdom.
...
`Since 2026` TEPHIConnect | Member
...
- "Investigation of new modern biomarkers for diagnosis and therapeutic response in urinary tract infections" | PhD and Postdoctoral Project | Project DPDP-11/2025 | Role: Epidemiological design and statistical analysis | Medical University of Plovdiv
...
- "Development of a scientific framework and national methodology for psychotherapy of dysfunctional schemas based on evidence" | Intra-university research project No. HO-2/2025 | Principal Investigator: Kristina Stoyanova, PhD (NIMH – Plovdiv) | Scientific Supervisor: Assoc. Prof. Zlatoslav Arabadjiev, MD, PhD | Role: Statistical Analysis Methods | Medical University of Plovdiv

`2026`

- "Conflict Dynamics and Illness Behavior" | Project No. РНО1400 | Project Leader: Assoc. Prof. Zlatoslav Arabadzhiev, MD, PhD | Role: Statistical Analysis Methods | Medical University of Plovdiv
...
- Academic Mentor | Project BG05SFPR001-3.002-0001 "From Higher Education to Employment" | Goal: Achieving a dynamic match between higher education supply and labor market demand by improving practical skills, promoting dual education, and strengthening university-employer partnerships

`November 2025 - Present`

- Beneficiary | Project BG05SFPR002-1.014-0001 "Encouraging specialization in specialties and areas with a shortage of specialists" | Human Resources Development Programme 2021-2027
...
- Science and Youth Conference 2026 | Plovdiv | *"Application of the Evidence-Based Psychotherapy Focusing on the Correlation Between Early Dysfunctional Schemas and Current Capabilities"* | Vladislav Velchev, Marina Cherneva, **Kostadin Kostadinov**, Kristina Stoyanova, Zlatoslav Arabadzhiev
...
- E-learning course | Behavioural and social research methodologies for the prevention and control of infectious diseases | ECDC | Online | 19 March 2026 | Certificate of Completion (Unique code: aDBwAbupxJ, 2 APHEA credits)
...
- GenEpi-BioTrain - Virtual training 24 | Antigen Surveillance: from evolution to immune escape | ECDC | Online | 23 and 25 March 2026 | Certificate of Completion

`July 2026`

- E-learning course | Community engagement and socially vulnerable populations | ECDC | Online | 4 July 2026 | Certificate of Completion (Unique code: V2swzV62FB, 2 APHEA credits)
