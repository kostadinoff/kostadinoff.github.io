...
Edward Tufte's work on the display of quantitative information is the reason my figures have almost no chrome: no gridline that is not needed, no colour that does not encode something, no legend where a direct label would do. The principle I keep returning to is the ratio of ink to information. It sounds like an aesthetic preference and it is actually an argument about honesty — decoration is where misleading figures hide.

The epidemiological and statistical books shaped something different: not what I compute, but *how I compute it*. A Handbook of Epidemiology and Modern Epidemiology gave me the conceptual structure — how measures relate to each other, when standardisation is appropriate, what confounding actually is. Modern Infectious Disease Epidemiology gave me the dynamic side: transmission, reproduction numbers, the reasoning behind outbreak investigation. Basic Epidemiology is the one I still hand to students. Zar's Biostatistical Analysis and the Handbook of Parametric and Nonparametric Statistical Procedures are my reference works for the procedural details: assumptions, small-sample behaviour, and what to do when the assumptions fail.
...
**MEGA.** Sync and backup. Projects, teaching materials, the shared bibliography and the CSL styles all live there, which is what lets the same workflow follow me between machines. It is also why a lost laptop would be an inconvenience rather than a catastrophe.
...
**AI assistants — Claude and Gemini.** For drafting, for arguing with, for rubber-ducking a piece of code, for turning a pile of my own lecture notes into something a student can revise from. NotebookLM has particularly earned its place because it works on *my* sources rather than the open internet, which makes its answers checkable against documents I chose. That is the whole distinction, and it is the one I would insist on: these tools are for the work I could do slowly, never for the work I could not do at all.
