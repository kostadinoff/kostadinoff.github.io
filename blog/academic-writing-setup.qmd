...
**AI assistants, and NotebookLM in particular.** For drafting, for arguing with, for rubber-ducking a piece of code, for turning a pile of my own lecture notes into something a student can revise from. NotebookLM has especially earned its place because it works on *my* sources rather than the open internet, which makes its answers checkable against documents I chose — the notebooks on my [study guides](../study-guide.qmd) page are built this way. That is the whole distinction, and the one I would insist on: these tools are for work I could do slowly, never for work I could not do at all.
