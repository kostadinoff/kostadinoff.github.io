...
**Automatically reported.** Numbers reach the manuscript by inline code, not by transcription. `Median age was 62.4 years` is not typed; it is computed. Typing numbers into prose is a step that has no upside and a [well-documented failure rate](https://doi.org/10.3758/s13428-015-0664-2) — in psychology, where this has been checked at scale, roughly half of published papers contain at least one inconsistent statistic.
