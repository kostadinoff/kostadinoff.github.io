...
\item
  ...
  Higher Education to Employment'' (``ОТ ВИСШЕ ОБРАЗОВАНИЕ КЪМ
  ЗАЕТОСТ'') \textbar{} Goal: Achieving a dynamic match between higher
  education supply and labor market demand by improving practical
  skills, promoting dual education, and strengthening
...
\begin{itemize}
\item
  Работна среща на МЗ, МЗХ, БАБХ, РЗИ и „Информационно обслужване`` АД
  \textbar{} \emph{„Подобряване на надзора на грип и други вирусни
  респираторни патогени чрез интегриране на всички съществуващи системи
  за надзор и използване на единен подход в сферата на здравеопазването
  на хората и здравеопазването на животните. Работа по регионални и
  специфични за страната въпроси: свързани с грипа в Югоизточна
  Европа``} \textbar{} Лектор
\item
  ISEE 2026 \textbar{}
