...
REAL-WORLD EVIDENCE FROM BULGARIA. \emph{Value in Health Regional
Issues} \textbf{2025}, \emph{49}, 101385.
...
REAL-WORLD EVIDENCE FROM BULGARIA. \emph{Value in Health Regional
Issues} \textbf{2025}, \emph{49}, 101303.
...
Functional Outcome and Survival in Acute Ischemic Stroke.
...
\emph{Arthritis \& Rheumatology} \textbf{2025}, \emph{77} (suppl 9).}
...
Impact Assessment in Bulgarian City Planning -- Why and How? \emph{AESOP
Congress 2025} \textbf{2025}.}
...
Bulgarian Urban Adults. \emph{ISEE 2026} \textbf{2026}.}
...
\item
  ...
  Communities'' \textbar{}
  \emph{\href{https://hiddeneurope-jeanmonnet.uni-plovdiv.net/2024/10/\%d0\%bf\%d1\%80\%d0\%be\%d0\%b3\%d1\%80\%d0\%bc\%d0\%b0-\%d0\%bd\%d0\%b0-\%d0\%bd\%d0\%b0\%d1\%83\%d1\%87\%d0\%bd\%d0\%b0\%d1\%82\%d0\%b0-\%d0\%ba\%d0\%be\%d0\%bd\%d1\%84\%d0\%b5\%d1\%80\%d0\%b5\%d0\%bd\%d1\%86\%d0\%b8\%d1\%8f-\%d0\%be\%d0\%ba/}{``Research
