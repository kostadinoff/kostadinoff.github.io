...
\item
  ...
  \textbar{} \emph{``Enhancing Patient-Centered Care through Simulation
  Training with Virtual Reality Glasses''} \textbar{}
  https://publisher.mu-plovdiv.bg/wp-content/uploads/published-online/public-health-conf/2024/abstract-book.html\#p=56
  \textbar{} Gergana Petrova, \textbf{Kostadin Kostadinov}, Valentina
  Lalova, Svetla Ivanova \textbar{} Awarded with the ``Best
  Presentation'' prize
\end{itemize}
...
\item
  ...
  in Infectious Disease Prevention''} \textbar{} \emph{``Assessment of
  Occupational Risk Exposures and Compliance with Standard Precautions
  among Medical Staff''} \textbar{}
  http://bulepid.org/\_upload2018/PROGRAMA\%202024-final.pdf \textbar{}
  Velina Stoeva, Hristiana Batselova, \textbf{Kostadin Kostadinov},
  Kiril Atliev
\end{itemize}
...
\item
  ...
  Communities'' \textbar{} \emph{``Research on the Link Between Air
  Pollution, Urban Environment Characteristics, and Population Health''}
  \textbar{}
  https://hiddeneurope-jeanmonnet.uni-plovdiv.net/2024/10/\%d0\%bf\%d1\%80\%d0\%be\%d0\%b3\%d1\%80\%d0\%bc\%d0\%b0-\%d0\%bd\%d0\%b0-\%d0\%bd\%d0\%b0\%d1\%83\%d1\%87\%d0\%bd\%d0\%b0\%d1\%82\%d0\%b0-\%d0\%ba\%d0\%be\%d0\%bd\%d1\%84\%d0\%b5\%d1\%80\%d0\%b5\%d0\%bd\%d1\%86\%d0\%b8\%d1\%8f-\%d0\%be\%d0\%ba/
  \textbar{} Assoc. Prof.~Dr.~Angel Djambov, \textbf{Asst. Dr.~Kostadin
  Kostadinov}, Prof.~Donka Dimitrova \textbar{} Plovdiv University
  ``Paisii Hilendarski'' \textbar{} Plovdiv
\end{itemize}
...
\tightlist
\item
  XVIII National Congress of Cardiology \textbar{} \emph{``The Role of
  Air Pollution in Cardiovascular Disease Genesis''} \textbar{}
  https://www.bgcardio.org/storage/app/media/uploaded-files/XVIII\%20Congress\%20program\_web.pdf
  \textbar{} \textbf{Kostadin Kostadinov} \textbar{} Plovdiv
\end{itemize}
...
\item
  ...
  \textbar{} ECDC/AURORAE \textbar{} Online- GenEpi-BioTrain - Virtual
  training 22 \textbar{} Genomic epidemiology and outbreak investigation
  of Brucella spp. in a One Health context \textbar{} ECDC \textbar{}
  Online
\end{itemize}
